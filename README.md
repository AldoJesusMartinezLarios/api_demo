...
| 9  | Status Code         | 200 Ok                             |
| 10 | Response Type       | application/json                   |
| 11 | Response            | {"version": "v1","message": "Lista de contactos","datetime": "27/9/23 14:30","data": [{"id_contacto": 1,"primer_apellido": "Ejemplo","segundo_apellido": "Apellido","edad": 30,"telefono": "123-456-7890"}]} |
...
| 12 | curl | curl -X 'POST' 'http://localhost:8000/contactos' -H 'accept: application/json' -H 'Content-Type: application/json' -d '{"primer_apellido": "Nuevo","segundo_apellido": "Apellido","edad": 35,"telefono": "555-555-5555"}' |
| 13 | Status Code (error) | NA |
| 14 | Response Type (error) | NA |
| 15 | Response (error) | NA |
...
| 12 | curl | curl -X 'PUT' 'http://localhost:8000/contactos/?id_contactos' -H 'accept: application/json' -H 'Content-Type: application/json' -d '{"primer_apellido": "Actualizado","segundo_apellido": "Apellido","edad": 40,"telefono": "555-555-5555"}' |
| 13 | Status Code (error) | 404 Not Found (Si el contacto no existe) |
| 14 | Response Type (error) | application/json |
| 15 | Response (error) |{"version": "v1","message": "El contacto con ID {id_contactos} no se encontró"} |
